...
// 
// gcc -o tutorial02.out tutorial02.c -lavformat -lavcodec -lswscale -lSDL2 -I/usr/local/include -L/usr/local/lib
//
...
int main(int argc, const char * argv[]) {
    ...
    bmp = SDL_CreateTexture(renderer, SDL_PIXELFORMAT_YV12, SDL_TEXTUREACCESS_STREAMING, codec_ctx->width, codec_ctx->height);
    ...
    av_image_fill_arrays(frame_out->data, frame_out->linesize, buffer, AV_PIX_FMT_YUV420P, codec_ctx->width, codec_ctx->height, 1);
